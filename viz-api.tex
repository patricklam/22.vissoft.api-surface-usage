...
\subfigure[Usage Scenario 1: Library \textit{jsoup}, called by two clients, \textit{ez-vcard} and \textit{JsoupXpath}.
\label{fig:usagescenario1}]
{\includegraphics[scale=1,width=16cm,height=8cm]{images/usage-scenario1.png}}
\hspace{7mm}

\subfigure[Usage Scenario 2: Client \textit{dataprocessor} calls library \textit{fastjson}.
\label{fig:usagescenario2}]
{\includegraphics[scale=1,width=11cm,height=5cm]{images/usage-scenario2.png}}
