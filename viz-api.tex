...
\subfigure[Usage Scenario 1: Usage of the library, $jsoup$ by two clients, $ez-vcard$  and $JsoupXpath$
\label{fig:usagescenario1}]
{\includegraphics[scale=1,width=16cm,height=8cm]{images/usage-scenario1.png}}
\hspace{7mm}

\subfigure[Usage Scenario 2: Interaction of the client, $dataprocessor$ with the library, $fastjson$
